...
export default function Penilaian({ studentId, onBack }: Props) {
  const { user } = useAuth();
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <button data-testid="button-back" onClick={onBack} className="flex items-center gap-2 text-sm font-medium" style={{ color: "#84B179" }}>
